...
public interface UserRepository extends JpaRepository<UserEntity, Integer> {
	...
	Optional<List<UserEntity>> getUserEntitiesByUsernameContainsAndCreationDateBeforeAndCreationDateAfterAndPrivilegeInAllIgnoreCaseOrderByUserIdAsc(@Nullable String username, @Nullable Date creationDate, @Nullable Date creationDate1, @Nullable Collection<Privilege> privileges, Pageable pageable);
